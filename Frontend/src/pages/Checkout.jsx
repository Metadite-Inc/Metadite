                ...
                <div className="p-6">
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center">
                        <div className={`w-5 h-5 rounded-full border mr-3 flex items-center justify-center ${
                          paymentMethod === 'mpesa' ? 'border-metadite-primary' : 'border-gray-300'
                        }`}>
                          {paymentMethod === 'mpesa' && (
                            <div className="w-3 h-3 rounded-full bg-metadite-primary"></div>
                          )}
                        ...
                        <span className="ml-2 text-xs text-gray-500">(Local payments)</span>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-gray-200 pt-3 mt-3">
                      <div className="flex justify-between font-bold">
                        <span>Total</span>
                        <span className="text-lg">${(totalAmount + 9.99 + (totalAmount * 0.08)).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
