...
import { Users, Bot, Search, Filter, Loader2, UserCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className={`flex-1 pt-20 pb-12 px-4 ${
        ...
        <div className="container mx-auto max-w-7xl">
          {/* Header */}
          <div className="bg-gradient-to-r from-metadite-primary to-metadite-secondary rounded-xl p-8 mb-8 text-white">
                ...
                <div className="p-6">
                  ...
                  {moderator.assignedModels?.length > 0 ? (
                    <div className="space-y-3">
                      {moderator.assignedModels.slice(0, 3).map((model) => (
                        <div
                          key={model.id}
                      ...
                      {moderator.assignedModels.length > 3 && (
                        <div className={`text-center py-2 text-sm ${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>
                          +{moderator.assignedModels.length - 3} more models
                        </div>
                      )}
                    </div>
                  ) : (
